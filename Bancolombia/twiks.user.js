...
;(function ($) {
  ...
  $(document).ajaxComplete(function () {
    $('[aria-describedby="gridGroupProductID_home_extData.COP"] > span, [aria-describedby="gridProductID_creditCards_extData.minVals"] > span, [aria-describedby="gridProductID_creditCardDetails_amount"] > span').contents().filter(function () {
